...
class m160212_060402_table_city_from_file_2 extends Migration
{
    public function up()
    {
        $this->createTable('city_from_file_2', [
            'id' => Schema::TYPE_PK,
    ...
    {
        echo "m160212_060402_table_city_from_file_2 cannot be reverted.\n";
